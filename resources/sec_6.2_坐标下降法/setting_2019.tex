...
\usepackage{dsfont}
\usepackage{mathrsfs}
\usepackage[T1]{fontenc} % OT1 encoding  to show < and > correctly in text mode
...
\newif\ifslidetitle
\slidetitletrue % whether show title of \slidetitle
%\def\ifdisplayslidetitlefalse
...
\newcommand{\hot}[1]{{\color{dred}\textbf{#1}}}
...
\ifslidetitle
    \newcommand{\slidetitle}[1]{\medskip{\large \textbf{\color{mylblue}#1}}}
\else
...
\newenvironment{summary}[1][Summary]{\par\medskip   \textbf{\large#1 } }{ \medskip}
...
\renewenvironment{proof}[1][Proof]{\noindent\textbf{#1.} }{\mbox{} \hfill{\small\textrm{$\Box$}}\vspace{1ex}}
 ...
 \newenvironment{analysis}[1][Analysis.]{\par\medskip \color{blue}\textbf{\large#1 }}{ \medskip}
