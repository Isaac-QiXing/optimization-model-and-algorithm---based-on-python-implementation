...
\newenvironment{mydefinition}[1][定义]{\par\medskip   \color{dblue}\textbf{#1 } }{ \medskip}
\newenvironment{mytheorem}[1][]{\par\medskip   \color{dblue}\textbf{定理 {\ifthenelse{\equal{#1}{}}{}{[#1]}} } }{ \medskip}
\newenvironment{myexample}[1][示例]{\par\medskip   \color{dblue}\textbf{#1 } }{ \medskip}
\newenvironment{summary}[1][总结]{\par\medskip   \color{dred}\textbf{\large#1 } }{ \medskip}
\newenvironment{remark}[1][评论]{\par\medskip   \color{dblue}\textbf{\large#1 } }{ \medskip}
